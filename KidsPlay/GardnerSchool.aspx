<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GardnerSchool.aspx.cs" Inherits="GardnerSchool" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-image:url(Images/stage_info_blank.png); background-repeat:no-repeat;" class="BackGroundImage">
            ...
            <div class="TextMid3">
                <center><h1>The Gardner School</h1></center>
                <center>To enroll in The Gardner School Kids Play Program</center>
