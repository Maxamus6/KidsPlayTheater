<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StMatthewsEpiscopalPreschool.aspx.cs" Inherits="StMatthewsEpiscopalPreschool" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-image:url(Images/stage_info_blank.png); background-repeat:no-repeat;" class="BackGroundImage">
            ...
            <div class="TextMid3">
                <center><h1>St. Matthew's Episcopal Preschool</h1></center>
                <center>To enroll in St. Matthew's Episcopal Preschool Kids Play Program</center>
                <center>Contact the School Director or Assistant Director and enroll in the Drama Afterschool Program.</center>
            </div>
