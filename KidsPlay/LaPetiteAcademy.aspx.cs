...
public partial class LaPetiteAcademy : System.Web.UI.Page
{
    ...
    public void SendEmailMessage(object sender, EventArgs e)
    {
        ...
        string Referral = "Name of Referral: " + txtReferral.Text;
        ...
        oMail.Body = parentsName + " <br /> " + parentsEmail + " <br /> " + parentsPhoneNumber + " <br /> " + Address1 + " <br /> " + Address2 + " <br /> " + childName + " <br /> " + " <br />" + DateOfBirth + " <br /> " + Allergies + " <br /> " + schoolName + " <br /> " + teachersName + " <br /> " + Referral;
