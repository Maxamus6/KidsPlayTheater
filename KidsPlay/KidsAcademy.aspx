<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KidsAcademy.aspx.cs" Inherits="EnrollmentPages_KidsAcademy" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-image:url(Images/stage_info_blank.png); background-repeat:no-repeat;" class="BackGroundImage">
            ...
            <div class="TextMid3">
                <center><h1>Kids Academy</h1></center>
                <div>
                    <center>
                ...
                <div style="padding-top:20px; padding-left:30px;">
                    <div>
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:Button OnClick="SendEmailMessage" Text="Next" runat="server"/>
                                </td>
                            </tr>
                        </table>
                    </div>
