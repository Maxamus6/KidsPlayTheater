<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MiddletownChristianPreschool.aspx.cs" Inherits="MiddletownChristianPreschool" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-image:url(Images/stage_info_blank.png); background-repeat:no-repeat;" class="BackGroundImage">
            ...
            <div class="TextMid3">
                <center><h1>Middletown Christian Preschool</h1></center>
                <div>
                    <center>
                    ...
                    <div>
                        <table>
                            ...
                            <tr>
                                ...
                                <td><asp:TextBox ID="SchoolName" runat="server" Width="240px">Middletown Christian Preschool</asp:TextBox></td>
                            </tr>
                            <tr>
