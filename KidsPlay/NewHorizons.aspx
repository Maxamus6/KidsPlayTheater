<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewHorizons.aspx.cs" Inherits="NewHorizons" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-image:url(Images/stage_info_blank.png); background-repeat:no-repeat;" class="BackGroundImage">
            ...
            <div class="TextMid3">
                <center><h1>New Horizons</h1></center>
                <div>
                    <center>
                    ...
                    <div>
                        <table>
                            ...
                            <tr>
                                ...
                                <td><asp:TextBox ID="SchoolName" runat="server" Width="240px">New Horizons</asp:TextBox></td>
                            </tr>
                            <tr>
