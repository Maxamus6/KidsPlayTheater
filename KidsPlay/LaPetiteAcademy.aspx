<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LaPetiteAcademy.aspx.cs" Inherits="LaPetiteAcademy" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-image:url(Images/stage_info_blank.png); background-repeat:no-repeat;" class="BackGroundImage">
            ...
            <div class="TextMid3">
                <center><h1>La Petite Academy</h1></center>
                <div>
                    <center>
                        All Students enrolling in the Kids Play program must complete an <a href="EnrollmentDocs/Parent%20Enrollment%20form2.pdf" target="_blank">enrollment form.</a> <br /> Please return 
                        this form to your child’s School Office.
                    </center>
                </div>
                <div style="padding-top:20px">
                    <center>
                        To make a payment online, please answer the following questions and select a payment option.
                    </center>
                </div>
                    ...
                    <div>
                        <table>
                            ...
                            <tr>
                                ...
                                <td><asp:TextBox ID="SchoolName" runat="server" Width="240px">Kids Academy</asp:TextBox></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><span>Name of Referral:</span></td>
                                <td><asp:TextBox ID="txtReferral" runat="server" Width="240px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>
